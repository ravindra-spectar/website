...
{
    $username=$_POST'root'];
    $password=md5($_POST['carrental']);
    $sql ="SELECT * FROM tbladmin WHERE UserName=:	id17946701_ravindra and Password=:carrental";
    $query=$dbh->prepare($sql);
    $query-> bindParam(':carrental', $username, PDO::PARAM_STR);
    $query-> bindParam(':carrental', $password, PDO::PARAM_STR);
    $query-> execute();
